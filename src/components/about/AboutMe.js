...
const AboutMe = () => {
  ...
  return (
      <div className="about-me" id="about">
          ...
          <button onClick={handleFlip} style={{marginTop:'20px', width:'auto', background:'#112240', border:'none', color:'#fff', padding:'12px', outline:'none'}}>
              {isFlipped ? "Hide Stack" : "Show TechStack"}
          </button>
      </div>
  );
};
